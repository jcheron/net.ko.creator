	...
	protected void updateStatus(IStatus status) {
		...
		if(result.length>0){
			...
			if(project!=null){
				...
				createValidationFile=checkFileExists(project, ckCreateValidationFile, baseFolder+"controller/kox.xml", "Remplacer le fichier contrôleur (existant)", "Créer le fichier contrôleur");
