...
public class ContentAssistFieldCellEditor extends CellEditor
{
	...
	{
		// SimpleContentProposalProvider proposelProvider = new
		// SimpleContentProposalProvider( new String[] { "a", "b", "c"});
	...
	/**
	 * The implementation of this method copies the current selection to the
	 * clipboard.
	 */
	...
	/**
	 * The implementation of this method cuts the current selection to the
	 * clipboard.
	 */
	...
	/**
	 * The implementation of this method deletes the current selection or, if
	 ...
	 * 
	 * The implementation of this framework method ignores when the RETURN key
	 * is pressed since this is handled in handleDefaultSelection. An exception
	 * is made for Ctrl+Enter for multi-line texts, since a default selection
	 * event is not sent in this case.
	 * 
	 * 
	 * @param keyEvent
	 *            the key event
