...
public class ExpandBarZone extends ExpandBar {
				...
				if(z.getTemplateType().equals(templateType) || TemplateType.ttNone.equals(z.getTemplateType())){
					if(z.getType().equals(zoneType)){
						//if(!z.getId().equals("_defaultTemplate"))
							tableViewer.add(z);
							if(getColorizedItems()!=null)
								getColorizedItems().add(z.getRegExp(), z.getType().getColor());
						//else
	...
	private ColorizedItemsList getColorizedItems(){
		ColorizedItemsList result=null;
		if(textTemplate instanceof MarkdownTextEditor)
			((MarkdownTextEditor)textTemplate).getColorizedItems();
		else if(textTemplate instanceof KstyledText)
			((KstyledText)textTemplate).getColorizedItems();
		return result;
	}
	...
	public void setTemplateType(TemplateType templateType) {
		if(!this.templateType.equals(templateType)){
			...
			if(templateType.equals(TemplateType.ttList)|| templateType.equals(TemplateType.ttView)||templateType.equals(TemplateType.ttShow)){
				loadZones();
			}
	...
	public void setTextTemplate(Object textTemplate) {
